...
\subsubsection{Overparameterization Regularization strategies}

As we have anticipated earlier, the number of parameters of a deep neural model can be even extremely large -- usually
